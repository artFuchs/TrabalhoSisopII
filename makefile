...
CLIENT_OBJS=${BIN_DIR}/mainClient.o ${BIN_DIR}/client.o ${BIN_DIR}/folder_monitor.o
...
${BIN_DIR}/folder_monitor.o: ${SRC_DIR}/Client.cpp
	g++ -c ${SRC_DIR}/folder_monitor.cpp -o ${BIN_DIR}/folder_monitor.o ${CXXFLAGS} ${INCLUDE_FLAG}
